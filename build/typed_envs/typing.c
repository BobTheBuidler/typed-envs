...
PyInit_typing(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_typed_envs___typing");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "typed_envs__mypyc.init_typed_envs___typing");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
