...
PyInit_ENVIRONMENT_VARIABLES(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_typed_envs___ENVIRONMENT_VARIABLES");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "typed_envs__mypyc.init_typed_envs___ENVIRONMENT_VARIABLES");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
