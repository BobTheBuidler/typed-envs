...
PyObject *CPyInit_typed_envs(void)
{
    ...
    if (unlikely(CPyModule_typed_envs__internal == NULL))
        goto fail;
    modname = PyUnicode_FromString("typed_envs");
    ...
    Py_ssize_t is_pkg = 1;
    rv = CPyImport_SetDunderAttrs(CPyModule_typed_envs__internal, modname, shared_lib_file, ext_suffix, is_pkg);
    Py_DECREF(ext_suffix);
    Py_DECREF(shared_lib_file);
    if (rv < 0) goto fail;
    if (PyObject_SetItem(PyImport_GetModuleDict(), modname, CPyModule_typed_envs__internal) < 0)
        goto fail;
    Py_CLEAR(modname);
...
CPyL4: ;
    ...
    cpy_r_r7 = (CPyPtr)((CPyPtr)cpy_r_r6 + offsetof(PyListObject, ob_item));
...
CPyL3: ;
    ...
    cpy_r_r17 = CPyModule_typed_envs___registry;
    cpy_r_r18 = (PyObject *)&_Py_NoneStruct;
    cpy_r_r19 = cpy_r_r17 != cpy_r_r18;
    if (cpy_r_r19) goto CPyL11;
    cpy_r_r20 = CPyInitOnly_typed_envs___registry;
    cpy_r_r21 = CPyExec_typed_envs___registry;
    cpy_r_r22 = (PyObject **)&CPyModule_typed_envs___registry__internal;
    cpy_r_r23 = PyImport_GetModuleDict();
    cpy_r_r24 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs__mypyc' */
    cpy_r_r25 = CPyDict_GetItem(cpy_r_r23, cpy_r_r24);
    if (unlikely(cpy_r_r25 == NULL)) {
        CPy_AddTraceback("typed_envs/__init__.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typed_envs___globals);
        goto CPyL28;
    }
    cpy_r_r26 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__file__' */
    ...
    cpy_r_r28 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '.cpython-314-x86_64-linux-gnu.so' */
    cpy_r_r29 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs.registry' */
    cpy_r_r30 = CPyImport_ImportNative(cpy_r_r29, cpy_r_r20, cpy_r_r21, cpy_r_r22, cpy_r_r27, cpy_r_r28, 0);
    CPy_DECREF(cpy_r_r27);
    if (unlikely(cpy_r_r30 == NULL)) {
        CPy_AddTraceback("typed_envs/__init__.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typed_envs___globals);
        goto CPyL28;
    }
    CPyModule_typed_envs___registry = cpy_r_r30;
...
CPyL11: ;
    ...
    if (unlikely(cpy_r_r34 == NULL)) {
        ...
        goto CPyL29;
CPyL12: ;
    cpy_r_r35 = CPyModule_typed_envs___typing;
    cpy_r_r36 = (PyObject *)&_Py_NoneStruct;
    cpy_r_r37 = cpy_r_r35 != cpy_r_r36;
    if (cpy_r_r37) goto CPyL17;
    cpy_r_r38 = CPyInitOnly_typed_envs___typing;
    cpy_r_r39 = CPyExec_typed_envs___typing;
    cpy_r_r40 = (PyObject **)&CPyModule_typed_envs___typing__internal;
    cpy_r_r41 = PyImport_GetModuleDict();
    cpy_r_r42 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs__mypyc' */
    cpy_r_r43 = CPyDict_GetItem(cpy_r_r41, cpy_r_r42);
    if (unlikely(cpy_r_r43 == NULL)) {
        CPy_AddTraceback("typed_envs/__init__.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typed_envs___globals);
        goto CPyL28;
    }
    cpy_r_r44 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__file__' */
    ...
    cpy_r_r46 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '.cpython-314-x86_64-linux-gnu.so' */
    cpy_r_r47 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs.typing' */
    cpy_r_r48 = CPyImport_ImportNative(cpy_r_r47, cpy_r_r38, cpy_r_r39, cpy_r_r40, cpy_r_r45, cpy_r_r46, 0);
    CPy_DECREF(cpy_r_r45);
    if (unlikely(cpy_r_r48 == NULL)) {
        CPy_AddTraceback("typed_envs/__init__.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typed_envs___globals);
        goto CPyL28;
    }
    CPyModule_typed_envs___typing = cpy_r_r48;
    CPy_INCREF(CPyModule_typed_envs___typing);
    CPy_DECREF(cpy_r_r48);
CPyL17: ;
    cpy_r_r49 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('StringConverter',) */
    cpy_r_r50 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs.typing' */
    cpy_r_r51 = CPyStatic_typed_envs___globals;
    cpy_r_r52 = CPyImport_GetNativeAttrs(cpy_r_r50, cpy_r_r49, cpy_r_r49, cpy_r_r51);
...
CPyL18: ;
    ...
    cpy_r_r63 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    ...
    cpy_r_r70 = CPyStatic_typed_envs___globals;
    cpy_r_r71 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    ...
    cpy_r_r74 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'create_env' */
    cpy_r_r75 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvironmentVariable' */
    cpy_r_r76 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvVarFactory' */
    cpy_r_r77 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'ENVIRONMENT' */
    cpy_r_r78 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '_ENVIRONMENT_VARIABLES_SET_BY_USER' */
    cpy_r_r79 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '_ENVIRONMENT_VARIABLES_USING_DEFAULTS' */
    cpy_r_r80 = PyList_New(6);
    if (unlikely(cpy_r_r80 == NULL)) {
        CPy_AddTraceback("typed_envs/__init__.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typed_envs___globals);
        goto CPyL28;
    }
    cpy_r_r81 = (CPyPtr)((CPyPtr)cpy_r_r80 + offsetof(PyListObject, ob_item));
    cpy_r_r82 = *(CPyPtr *)cpy_r_r81;
    CPy_INCREF(cpy_r_r74);
    *(PyObject * *)cpy_r_r82 = cpy_r_r74;
    CPy_INCREF(cpy_r_r75);
    cpy_r_r83 = cpy_r_r82 + 8;
    *(PyObject * *)cpy_r_r83 = cpy_r_r75;
    CPy_INCREF(cpy_r_r76);
    cpy_r_r84 = cpy_r_r82 + 16;
    *(PyObject * *)cpy_r_r84 = cpy_r_r76;
    CPy_INCREF(cpy_r_r77);
    cpy_r_r85 = cpy_r_r82 + 24;
    *(PyObject * *)cpy_r_r85 = cpy_r_r77;
    CPy_INCREF(cpy_r_r78);
    cpy_r_r86 = cpy_r_r82 + 32;
    *(PyObject * *)cpy_r_r86 = cpy_r_r78;
    CPy_INCREF(cpy_r_r79);
    cpy_r_r87 = cpy_r_r82 + 40;
    *(PyObject * *)cpy_r_r87 = cpy_r_r79;
    cpy_r_r88 = CPyStatic_typed_envs___globals;
    cpy_r_r89 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__all__' */
    ...
    cpy_r_r92 = CPyStatic_typed_envs___globals;
    cpy_r_r93 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvironmentVariable' */
    ...
    if (unlikely(cpy_r_r94 == NULL)) {
        ...
        goto CPyL31;
CPyL26: ;
    cpy_r_r95 = CPyStatic_typed_envs___globals;
    cpy_r_r96 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'logger' */
...
CPyTagged CPyDef__typed_____int___3_build_subclass_obj_____call__(PyObject *cpy_r___mypyc_self__, PyObject *cpy_r_self) {
    ...
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AttributeError("typed_envs/_typed.py", "__int__", "__int___build_subclass_obj", "__mypyc_env__", 39, CPyStatic__typed___globals);
        goto CPyL5;
    }
...
PyObject *CPyDef__typed___build_subclass(PyObject *cpy_r_type_arg) {
    ...
    if (likely(PyUnicode_Check(cpy_r_r2)))
        ...
        CPy_TypeErrorTraceback("typed_envs/_typed.py", "build_subclass", 28, CPyStatic__typed___globals, "str", cpy_r_r2);
        goto CPyL63;
    }
...
char CPyDef__typed_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('annotations',) */
    cpy_r_r6 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__future__' */
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('lru_cache',) */
    cpy_r_r10 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'functools' */
    ...
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('Final', 'TypeVar') */
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r16);
    cpy_r_r17 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('EnvironmentVariable',) */
    cpy_r_r18 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs._env_var' */
    cpy_r_r19 = CPyStatic__typed___globals;
    cpy_r_r20 = CPyImport_ImportFromMany(cpy_r_r18, cpy_r_r17, cpy_r_r17, cpy_r_r19);
    if (unlikely(cpy_r_r20 == NULL)) {
        CPy_AddTraceback("typed_envs/_typed.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic__typed___globals);
        goto CPyL23;
    }
    CPyModule_typed_envs____env_var = cpy_r_r20;
    CPy_INCREF(CPyModule_typed_envs____env_var);
    CPy_DECREF(cpy_r_r20);
    cpy_r_r21 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    cpy_r_r22 = CPyStatic__typed___globals;
    cpy_r_r23 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'TypeVar' */
    ...
    cpy_r_r28 = CPyStatic__typed___globals;
    cpy_r_r29 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    ...
    cpy_r_r33 = CPyStatic__typed___globals;
    cpy_r_r34 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvironmentVariable' */
    cpy_r_r35 = CPyDict_GetItem(cpy_r_r33, cpy_r_r34);
    if (unlikely(cpy_r_r35 == NULL)) {
        CPy_AddTraceback("typed_envs/_typed.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic__typed___globals);
        goto CPyL23;
    }
    cpy_r_r36 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__repr__' */
    ...
    cpy_r_r39 = CPyStatic__typed___globals;
    cpy_r_r40 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvironmentVariable' */
    cpy_r_r41 = CPyDict_GetItem(cpy_r_r39, cpy_r_r40);
    if (unlikely(cpy_r_r41 == NULL)) {
        CPy_AddTraceback("typed_envs/_typed.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic__typed___globals);
        goto CPyL24;
    }
    cpy_r_r42 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__str__' */
    ...
    cpy_r_r44 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__origin__' */
    cpy_r_r45 = CPyStatic__typed___globals;
    cpy_r_r46 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvironmentVariable' */
    cpy_r_r47 = CPyDict_GetItem(cpy_r_r45, cpy_r_r46);
    if (unlikely(cpy_r_r47 == NULL)) {
        CPy_AddTraceback("typed_envs/_typed.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic__typed___globals);
        goto CPyL25;
    }
    cpy_r_r48 = CPyDict_Build(3, cpy_r_r32, cpy_r_r37, cpy_r_r38, cpy_r_r43, cpy_r_r44, cpy_r_r47);
    ...
    CPyStatic__typed_____TYPED_CLS_DICT_CONSTANTS = cpy_r_r48;
    CPy_INCREF(CPyStatic__typed_____TYPED_CLS_DICT_CONSTANTS);
    cpy_r_r49 = CPyStatic__typed___globals;
    cpy_r_r50 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__TYPED_CLS_DICT_CONSTANTS' */
    ...
    cpy_r_r53 = CPyStatic__typed___globals;
    cpy_r_r54 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'build_subclass' */
    cpy_r_r55 = CPyDict_GetItem(cpy_r_r53, cpy_r_r54);
    if (unlikely(cpy_r_r55 == NULL)) {
        CPy_AddTraceback("typed_envs/_typed.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic__typed___globals);
        goto CPyL23;
    }
    cpy_r_r56 = CPyStatic__typed___globals;
    cpy_r_r57 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'lru_cache' */
    ...
    cpy_r_r62 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('maxsize',) */
    cpy_r_r63 = PyObject_Vectorcall(cpy_r_r58, cpy_r_r61, 0, cpy_r_r62);
    CPy_DECREF(cpy_r_r58);
    if (unlikely(cpy_r_r63 == NULL)) {
        CPy_AddTraceback("typed_envs/_typed.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic__typed___globals);
        goto CPyL26;
    }
    PyObject *cpy_r_r64[1] = {cpy_r_r55};
    ...
    cpy_r_r67 = CPyStatic__typed___globals;
    cpy_r_r68 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'build_subclass' */
    cpy_r_r69 = PyDict_SetItem(cpy_r_r67, cpy_r_r68, cpy_r_r66);
    CPy_DECREF(cpy_r_r66);
...
CPyL15: ;
    ...
    return cpy_r_r39;
            ...
            PyObject *CPyInitOnly_typed_envs___registry(void)
            {
            ...
            PyObject *CPyInit_typed_envs___registry(void)
            {
                ...
                if (unlikely(CPyModule_typed_envs___registry__internal == NULL))
                    goto fail;
                modname = PyUnicode_FromString("typed_envs.registry");
                if (modname == NULL) CPyError_OutOfMemory();
                int rv = 0;
                PyObject *mod_dict = PyImport_GetModuleDict();
                PyObject *shared_lib = NULL;
                ...
                if (ext_suffix == NULL) CPyError_OutOfMemory();
                Py_ssize_t is_pkg = 0;
                rv = CPyImport_SetDunderAttrs(CPyModule_typed_envs___registry__internal, modname, shared_lib_file, ext_suffix, is_pkg);
                Py_DECREF(ext_suffix);
                Py_DECREF(shared_lib_file);
                if (rv < 0) goto fail;
                if (PyObject_SetItem(PyImport_GetModuleDict(), modname, CPyModule_typed_envs___registry__internal) < 0)
                    goto fail;
                Py_CLEAR(modname);
...
CPyL3: ;
    ...
    CPy_INCREF(CPyModule___future__);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('Any', 'Final') */
    ...
    CPy_INCREF(CPyModule_typed_envs____env_var);
    CPy_DECREF(cpy_r_r16);
    cpy_r_r17 = CPyModule_typed_envs___typing;
    cpy_r_r18 = (PyObject *)&_Py_NoneStruct;
    cpy_r_r19 = cpy_r_r17 != cpy_r_r18;
    if (cpy_r_r19) goto CPyL11;
    cpy_r_r20 = CPyInitOnly_typed_envs___typing;
    cpy_r_r21 = CPyExec_typed_envs___typing;
    cpy_r_r22 = (PyObject **)&CPyModule_typed_envs___typing__internal;
    cpy_r_r23 = PyImport_GetModuleDict();
    cpy_r_r24 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs__mypyc' */
    cpy_r_r25 = CPyDict_GetItem(cpy_r_r23, cpy_r_r24);
    if (unlikely(cpy_r_r25 == NULL)) {
    ...
    cpy_r_r28 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '.cpython-314-x86_64-linux-gnu.so' */
    cpy_r_r29 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs.typing' */
    cpy_r_r30 = CPyImport_ImportNative(cpy_r_r29, cpy_r_r20, cpy_r_r21, cpy_r_r22, cpy_r_r27, cpy_r_r28, 0);
    CPy_DECREF(cpy_r_r27);
    if (unlikely(cpy_r_r30 == NULL)) {
        CPy_AddTraceback("typed_envs/registry.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_registry___globals);
    ...
    CPyModule_typed_envs___typing = cpy_r_r30;
    CPy_INCREF(CPyModule_typed_envs___typing);
    CPy_DECREF(cpy_r_r30);
CPyL11: ;
    cpy_r_r31 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('EnvRegistry', 'VarName') */
    cpy_r_r32 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typed_envs.typing' */
    cpy_r_r33 = CPyStatic_registry___globals;
    cpy_r_r34 = CPyImport_GetNativeAttrs(cpy_r_r32, cpy_r_r31, cpy_r_r31, cpy_r_r33);
    if (unlikely(cpy_r_r34 == NULL)) {
        CPy_AddTraceback("typed_envs/registry.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_registry___globals);
        goto CPyL21;
        ...
        goto CPyL22;
CPyL12: ;
    cpy_r_r35 = PyDict_New();
    if (unlikely(cpy_r_r35 == NULL)) {
        CPy_AddTraceback("typed_envs/registry.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_registry___globals);
        goto CPyL21;
    }
    CPyStatic_registry___ENVIRONMENT = cpy_r_r35;
    CPy_INCREF(CPyStatic_registry___ENVIRONMENT);
    cpy_r_r36 = CPyStatic_registry___globals;
    cpy_r_r37 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'ENVIRONMENT' */
    ...
    CPyStatic_registry____ENVIRONMENT_VARIABLES_SET_BY_USER = cpy_r_r40;
    CPy_INCREF(CPyStatic_registry____ENVIRONMENT_VARIABLES_SET_BY_USER);
    cpy_r_r41 = CPyStatic_registry___globals;
    cpy_r_r42 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '_ENVIRONMENT_VARIABLES_SET_BY_USER' */
    ...
    cpy_r_r45 = PyDict_New();
    if (unlikely(cpy_r_r45 == NULL)) {
        CPy_AddTraceback("typed_envs/registry.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_registry___globals);
        goto CPyL21;
    }
    CPyStatic_registry____ENVIRONMENT_VARIABLES_USING_DEFAULTS = cpy_r_r45;
    CPy_INCREF(CPyStatic_registry____ENVIRONMENT_VARIABLES_USING_DEFAULTS);
    cpy_r_r46 = CPyStatic_registry___globals;
    cpy_r_r47 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '_ENVIRONMENT_VARIABLES_USING_DEFAULTS' */
    ...
    cpy_r_r50 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'ENVIRONMENT' */
    cpy_r_r51 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '_ENVIRONMENT_VARIABLES_SET_BY_USER' */
    cpy_r_r52 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '_ENVIRONMENT_VARIABLES_USING_DEFAULTS' */
    cpy_r_r53 = PyList_New(3);
    if (unlikely(cpy_r_r53 == NULL)) {
        CPy_AddTraceback("typed_envs/registry.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_registry___globals);
        goto CPyL21;
    }
    cpy_r_r54 = (CPyPtr)((CPyPtr)cpy_r_r53 + offsetof(PyListObject, ob_item));
    ...
    *(PyObject * *)cpy_r_r57 = cpy_r_r52;
    cpy_r_r58 = CPyStatic_registry___globals;
    cpy_r_r59 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__all__' */
    cpy_r_r60 = CPyDict_SetItem(cpy_r_r58, cpy_r_r59, cpy_r_r53);
...
CPyL22: ;
    ...
    goto CPyL12;
                ...
                PyObject *CPyInitOnly_typed_envs___typing(void)
                {
                ...
                PyObject *CPyInit_typed_envs___typing(void)
                {
                    ...
                    if (unlikely(CPyModule_typed_envs___typing__internal == NULL))
                        goto fail;
                    modname = PyUnicode_FromString("typed_envs.typing");
                    if (modname == NULL) CPyError_OutOfMemory();
                    int rv = 0;
                    PyObject *mod_dict = PyImport_GetModuleDict();
                    PyObject *shared_lib = NULL;
                    ...
                    if (ext_suffix == NULL) CPyError_OutOfMemory();
                    Py_ssize_t is_pkg = 0;
                    rv = CPyImport_SetDunderAttrs(CPyModule_typed_envs___typing__internal, modname, shared_lib_file, ext_suffix, is_pkg);
                    Py_DECREF(ext_suffix);
                    Py_DECREF(shared_lib_file);
                    if (rv < 0) goto fail;
                    if (PyObject_SetItem(PyImport_GetModuleDict(), modname, CPyModule_typed_envs___typing__internal) < 0)
                        goto fail;
                    Py_CLEAR(modname);
...
CPyL3: ;
    ...
    cpy_r_r21 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvRegistry' */
    cpy_r_r22 = (PyObject *)&PyDict_Type;
    cpy_r_r23 = CPyStatic_typing___globals;
    cpy_r_r24 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'VarName' */
    cpy_r_r25 = CPyDict_GetItem(cpy_r_r23, cpy_r_r24);
    if (unlikely(cpy_r_r25 == NULL)) {
        CPy_AddTraceback("typed_envs/typing.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typing___globals);
        goto CPyL19;
    }
    cpy_r_r26 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvironmentVariable[Any]' */
    ...
    if (unlikely(cpy_r_r28 == NULL))
        CPyError_OutOfMemory();
    PyObject *__tmp9 = cpy_r_r27.f0;
    PyTuple_SET_ITEM(cpy_r_r28, 0, __tmp9);
    PyObject *__tmp10 = cpy_r_r27.f1;
    PyTuple_SET_ITEM(cpy_r_r28, 1, __tmp10);
    cpy_r_r29 = PyObject_GetItem(cpy_r_r22, cpy_r_r28);
    CPy_DECREF(cpy_r_r28);
    if (unlikely(cpy_r_r29 == NULL)) {
        CPy_AddTraceback("typed_envs/typing.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typing___globals);
        goto CPyL19;
    }
    cpy_r_r30 = CPyStatic_typing___globals;
    cpy_r_r31 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'NewType' */
    cpy_r_r32 = CPyDict_GetItem(cpy_r_r30, cpy_r_r31);
    if (unlikely(cpy_r_r32 == NULL)) {
        CPy_AddTraceback("typed_envs/typing.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typing___globals);
        goto CPyL20;
    }
    PyObject *cpy_r_r33[2] = {cpy_r_r21, cpy_r_r29};
    cpy_r_r34 = (PyObject **)&cpy_r_r33;
    cpy_r_r35 = PyObject_Vectorcall(cpy_r_r32, cpy_r_r34, 2, 0);
    CPy_DECREF(cpy_r_r32);
    if (unlikely(cpy_r_r35 == NULL)) {
        CPy_AddTraceback("typed_envs/typing.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typing___globals);
        goto CPyL20;
    ...
    cpy_r_r36 = CPyStatic_typing___globals;
    cpy_r_r37 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'EnvRegistry' */
    cpy_r_r38 = CPyDict_SetItem(cpy_r_r36, cpy_r_r37, cpy_r_r35);
    CPy_DECREF(cpy_r_r35);
    cpy_r_r39 = cpy_r_r38 >= 0;
    if (unlikely(!cpy_r_r39)) {
    ...
    cpy_r_r40 = CPyStatic_typing___globals;
    cpy_r_r41 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'Callable' */
    ...
    *(PyObject * *)cpy_r_r46 = cpy_r_r43;
    cpy_r_r47 = CPyStatic_typing___globals;
    cpy_r_r48 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'Any' */
    cpy_r_r49 = CPyDict_GetItem(cpy_r_r47, cpy_r_r48);
    if (unlikely(cpy_r_r49 == NULL)) {
        CPy_AddTraceback("typed_envs/typing.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_typing___globals);
        goto CPyL22;
    }
    cpy_r_r50.f0 = cpy_r_r44;
    ...
    cpy_r_r52 = PyObject_GetItem(cpy_r_r42, cpy_r_r51);
    ...
    cpy_r_r53 = CPyStatic_typing___globals;
    cpy_r_r54 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'StringConverter' */
...
CPyL22: ;
    ...
    "\005\rEnvVarFactory\006logger\022typed_envs.factory\021typed_envs__mypyc\b__file__",
    "\003 .cpython-314-x86_64-linux-gnu.so\023typed_envs.registry\vENVIRONMENT",
    "\001\"_ENVIRONMENT_VARIABLES_SET_BY_USER",
    "\002%_ENVIRONMENT_VARIABLES_USING_DEFAULTS\021typed_envs.typing",
    "\001\017StringConverter",
