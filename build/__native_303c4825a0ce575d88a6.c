...
CPyL3: ;
    ...
    cpy_r_r38 = CPyStatics[58]; /* 'VarName' */
    ...
    cpy_r_r45 = CPyStatics[61]; /* 'NewType' */
    ...
    cpy_r_r51 = CPyStatics[57]; /* 'EnvRegistry' */
    ...
    cpy_r_r55 = CPyStatics[59]; /* 'Callable' */
